...
create_vulkan()
{
    ...
    vc_->desired_enabled_device_features_.samplerAnisotropy = VK_TRUE ;
    vc_->desired_enabled_device_features_.logicOp           = VK_TRUE ;
    ...
    if(check(create_logical_device(
            ...
            ,   &vc_->desired_enabled_device_features_
...
)
{
    ...
    log_debug_u32(desired_mip_levels) ;
    ...
    uint32_t automatic_mip_levels = desired_mip_levels ;
    if(0 == desired_mip_levels)
    {
        automatic_mip_levels = calc_mip_levels(tx_width, tx_height) ;
    }

    require(0 != automatic_mip_levels) ;
    *out_mip_levels = automatic_mip_levels ;
    log_debug_u32(*out_mip_levels) ;
