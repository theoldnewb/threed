...
// 1.000000, 0.000000, 0.000488, 0.000000
// 1.000000, 0.000000, 0.000488, 0.000000
// 1.000000, 155.000000, 0.000488, 0.151367
// 183.000000, 155.000000, 0.089355, 0.151367


static float const spw = 2048.0f ;
static float const sph = 1024.0f ;
...
static float const p1x = 1.0f ;
static float const p1y = 0.0f ;
static float const p2x = 1.0f ;
static float const p2y = 155.0f ;
static float const p3x = 183.0f ;
...
static float const t1u = 0.000488f ;
static float const t1v = 0.0f ;
static float const t2u = 0.000488f ;
static float const t2v = 0.151367f ;
static float const t3u = 0.089355f ;
